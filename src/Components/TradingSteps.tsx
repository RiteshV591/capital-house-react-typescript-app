  ...
  return (
    ...
    >
      <img
        ...
        alt="trading steps"
      />
      <div className="bg-primary md:bg-opacity-70 md:absolute md:top-0 w-full h-full flex flex-col justify-center items-center p-12 gap-10 lg:gap-14 xl:gap-20 2xl:gap-36">
